 ...
 */
public class HpBar extends Player
{
    private int barWidth = 45; // the width of the color portion of the bar
    private int barHeight = 6; // the height of the color portion of the bar
    ...
    //private World world = (ImageScrollWorld) getWorld();
     ...
     */
    public HpBar(String refText, String unitType)
    {
    ...
    private void newImage()
    {
        ...
        GreenfootImage leftImg = new GreenfootImage(referenceText + " ", (int) fontSize, borderColor, backgroundColor);
        GreenfootImage rightImg = (showTextualUnits) ? new GreenfootImage(" " + value + " " + unitOfMeasure, (int) fontSize, borderColor, backgroundColor) : new GreenfootImage(1, 1);
    ...
    /**
     * Method 'getborderColor': returns the current text and frame color
     *
    ...
    /**
     * Method 'setborderColor': sets a new color for the text and frame of the bar image
     *
     * @param 'color': the new color for the text and frame of the bar image
     */
    public void setborderColor(Color color) { borderColor = color; newImage(); }
